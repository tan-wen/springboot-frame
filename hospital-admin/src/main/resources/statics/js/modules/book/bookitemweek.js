$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'book/bookitemweek/list',
        datatype: "json",
        colModel: [			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.bookItemWeek.id == null ? "book/bookitemweek/save" : "book/bookitemweek/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
                contentType: "application/json",
			    data: JSON.stringify(vm.bookItemWeek),
			    success: function(r){
			    	if(r.code === 0){
		...
		getInfo: function(id){
			$.get(baseURL + "book/bookitemweek/info/"+id, function(r){
                vm.bookItemWeek = r.bookItemWeek;
            });
		},
